Módulos usados para construção da Aplicação:
Para validar o CPF: https://github.com/LaravelLegends/pt-br-validator

Para controlar as requisições e demais rotinas: Framework Laravel =>
...
- [Conteiner de injeção de dependência poderoso](https://laravel.com/docs/container).
- Múltiplos back-ends para [sessão](https://laravel.com/docs/session) and [cache](https://laravel.com/docs/cache) armazenamento.
- Expressivo, intuitivo [base de dados ORM](https://laravel.com/docs/eloquent).
- Abstração de banco de dados [migrações de esquema](https://laravel.com/docs/migrations).
